...
"%JAVA_HOME%\bin\jpackage" --type app-image --input "%ROOT%target" --main-jar moneymanager-1.0.0.jar --name LucaMoneyManager --app-version 1.0.0 --dest "%DIST%\app" --java-options "-Dfile.encoding=UTF-8"
